 ...
 * @param <T>
 */
public class KinesisStreamsProducerClient<T>{
	private  static final Logger log = Logger.getLogger(KinesisStreamsProducerClient.class);
	
	
	private static KinesisStreamsProducerClient<?> dsproducer = null;

	public static KinesisStreamsProducerClient<?> singleton() throws IOException {
		if (dsproducer == null) {
			dsproducer = new KinesisStreamsProducerClient();
		}
		return dsproducer;
	}
	...
	public KinesisStreamsProducerClient() throws IOException {
	...
	public KinesisStreamsProducerClient(AWSCredentials credentials) throws IOException {
		InputStream props = Resources.getResource("aws_producer.props").openStream();
		properties = new Properties();
		properties.load(props);
	...
	public void send(byte[] message) {
		...
		myStreamName = properties.getProperty("stream.id");
